...
$(function () {
    ...
    $("#drinks").click(function () { /* Here we show and hide the field. */
        $("#allStockBeer").show("slow");
        $("#allStockWine").hide("slow");
        $("#SearchStock").hide("slow");
    ...
    $("#runningout").click(function () { /* Here we show and hide the field. */
        $("#allStockBeer").hide("slow");
        $("#allStockWine").show("slow");
        $("#SearchStock").hide("slow");
    ...
    $(getAllBeers(getBeerData())).appendTo("#allStockBeer");
    $(getAllWines(getWineData())).appendTo("#allStockWine");
...
function SearchInStock() {
    ...
    var allBeverages1=getBeerData();/* this is probably a redundant way*/
